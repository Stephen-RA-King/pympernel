...
def github_create_repo() -> None:
    body_json = {"name": "pympernel", "description": "placeholder"}
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    url_public_key = (
        ...
        "/pympernel/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/pympernel/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    body_json = {
        "name": "pympernel",
        "repository": {
            "url": "https://github.com/Stephen-RA-King" "/pympernel",
            "type": "git",
        },
...
def readthedocs_update() -> None:
    body_json = {"name": "pympernel", "default_branch": "main"}
...
def main() -> None:
    ...
    file_path = r"\pympernel\Lib\site-packages\semantic_release\repository.py"
